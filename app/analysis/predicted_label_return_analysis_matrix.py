...
def calculate_predicted_label_returns(prediction_data: pd.DataFrame, window_size: int = 20) -> Dict:
    """
...
def generate_return_distribution_plot(ticker: str, model: str, feature_set: str, window_size: int) -> None:
    ...
    try:
        ...
        with DBSession() as session:
            ...
            returns_results = calculate_predicted_label_returns(prediction_data, window_size)
...
def generate_combined_matrix_plot(model: str, feature_set: str, window_size: int) -> None:
    ...
    try:
        ...
        with DBSession() as session:
            ...
            output_dir = os.path.join(os.path.dirname(__file__), "images")
            os.makedirs(output_dir, exist_ok=True)  # Ensure the directory exists
            output_file = os.path.join(output_dir, f"combined_return_distribution_matrix_predicted.png")
